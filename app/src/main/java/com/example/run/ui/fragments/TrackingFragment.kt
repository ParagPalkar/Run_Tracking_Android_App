package com.example.run.ui.fragments
...
import com.example.run.services.Polyline
import com.example.run.services.Polylines
...
class TrackingFragment : Fragment(R.layout.fragment_tracking) {
    ...
    private fun endRunAndSaveToDb() { //Save all the runs in database
        map?.snapshot { bmp ->
